...
dummy = foreach(ID = good_match_faintest$bestmatch[,1])%dopar%{
  ...
  seg_cen = segim[101,101] #select the seg map value of the central pixel
  segim[segim == seg_cen] = 0L #We make this so in the next step we don't mask the central star, that are the wanted pixels
