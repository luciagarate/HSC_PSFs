...
stack_outer = Rfits_read(paste0('/Path2StarFits/Outer_Star_Stack_',region,'_',band,'.fits'), pointer=FALSE) #outer stack
...
sel_pix_o = which(sel_grid_o[,3]> 150 & sel_grid_o[,3] < 160) #this is the normalisation annulus that we use to combine the
...
stack_mid = Rfits_read(paste0('/Path2StarFits/Mid_Star_Stack_',region,'_',band,'.fits'), pointer=FALSE) #middle stack
...
stack_inner = Rfits_read(paste0('/Path2StarFits/Inner_Star_Stack_',region,'_',band,'.fits'), pointer=FALSE) #inner stack
...
stack_core = Rfits_read(paste0('/Path2StarFits/Core_Star_Stack_',region,'_',band,'.fits'), pointer=FALSE)  #core stack
